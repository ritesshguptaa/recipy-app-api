...
class PublicIngredientApiTests(TestCase):
    """Test the public avaiabale Ingredient api """
...
class PrivateIngredientApiTest(TestCase):
    ...
    def test_retrive_ingredients_list(self):
        ...
        Serialzer = IngredientSerializer(ingredient, many=True)
        self.assertEqual(res.status_code, status.HTTP_200_OK)
        self.assertEqual(res.data,Serialzer.data)

    def test_ingredient_limited_to_user(self):
        """Test that ingredient returned are for the authenticated users"""
